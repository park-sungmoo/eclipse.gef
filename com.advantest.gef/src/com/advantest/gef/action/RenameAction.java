package com.advantest.gef.action;
...
import com.advantest.gef.Activator;
import com.advantest.gef.RenameWizard;
...
public class RenameAction extends SelectionAction {
	...
	protected void init() {
		...
		ImageDescriptor icon = AbstractUIPlugin.imageDescriptorFromPlugin(Activator.PLUGIN_ID, "icons/eclipse16.gif");
		if(icon != null) {
